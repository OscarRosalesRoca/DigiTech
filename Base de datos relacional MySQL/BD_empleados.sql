...
SELECT salario FROM empleados WHERE dept_no='20';

SELECT * FROM empleados;

SELECT comision FROM empleados WHERE comision is not null;

SELECT salario FROM empleados ORDER BY salario DESC LIMIT 1;

SELECT apellido FROM empleados ORDER BY apellido DESC LIMIT 1;

SELECT apellido, salario FROM empleados ORDER BY salario DESC LIMIT 1;

SELECT salario FROM empleados ORDER BY salario ASC LIMIT 1;

SELECT apellido, salario FROM empleados ORDER BY salario ASC LIMIT 1;

SELECT SUM(salario) AS suma_salario FROM empleados;

SELECT STDDEV(salario) AS desviacion_tipica_salarios FROM empleados;

SELECT DISTINCT dept_no  FROM empleados;

SELECT dept_no FROM empleados WHERE dept_no=10;

SELECT dept_no FROM empleados WHERE dept_no=30;

SELECT dept_no FROM empleados WHERE dept_no=20;

SELECT apellido FROM empleados WHERE apellido LIKE 'a%';

SELECT apellido FROM empleados WHERE apellido LIKE 'a%' ORDER BY salario DESC LIMIT 1;